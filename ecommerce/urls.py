...
from products.views import producto_list, home
...
urlpatterns = [
    ...
    path('panel/productos/<int:pk>/editarar/', admin_views.editar_producto, name='editar_product'),
    path('panel/productos/<int:pk>/eliminar/', admin_views.eliminar_producto, name='eliminar_product'),
