...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('products', '0003_cliente_grupocliente_direccion_cliente_grupo'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('carrito', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='products.carrito', verbose_name='Carrito')),
                ...
                ('talle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.talle', verbose_name='Talle')),
            ],
            options={
