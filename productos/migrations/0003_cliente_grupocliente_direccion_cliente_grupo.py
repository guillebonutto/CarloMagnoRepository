...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('productos', '0002_alter_productostock_options_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='direcciones', to='productos.cliente', verbose_name='Cliente')),
            ],
            options={
